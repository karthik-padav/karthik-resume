export async function getData(url) {
  ...
  data = {
    ...
    menu: [
      ...
      { code: "SKILLS", title: "Skills", url: "/skills" },
    ...
    about_me: [
      ...
      },
      {
        ...
        content: [
          ...
          "I have never played Candy Crush or Pokémon GO.",
          "I still love backing up stuff by emailing myself.",
          "Not a Party animal, Always yes for a road trip.",
          "I use a windows 10.",
        ],
      },
    ],
